...
export const rolePermissions: Record<Role, string[]> = {
  ...
  "support-worker": ["dashboard", "participants", "shift", "timeline", "roster", "timepay", "assistant", "support-circle", "marketplace", "learning", "community", "notifications", "settings", "help"],
  "team-leader": ["dashboard", "participants", "shift", "timeline", "roster", "timepay", "compliance", "billing", "assistant", "support-circle", "marketplace", "learning", "community", "reports", "notifications", "settings", "help"],
  therapist: ["dashboard", "participants", "timeline", "assistant", "support-circle", "learning", "reports", "notifications", "settings", "help"],
  "provider-admin": ["provider", "dashboard", "participants", "timeline", "roster", "timepay", "compliance", "billing", "assistant", "support-circle", "marketplace", "learning", "community", "reports", "notifications", "settings", "help"],
  ceo: ["executive", "provider", "participants", "timeline", "timepay", "compliance", "billing", "support-circle", "marketplace", "reports", "notifications", "settings", "help"],
  "system-admin": ["dashboard", "participants", "roster", "timepay", "compliance", "billing", "reports", "notifications", "settings", "help"],
};
