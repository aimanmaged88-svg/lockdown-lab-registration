...
export const rolePermissions: Record<Role, string[]> = {
  ...
  "support-worker": ["dashboard", "participants", "shift", "timeline", "roster", "timepay", "arrivals", "incidents", "assistant", "comms", "support-circle", "marketplace", "learning", "community", "wellbeing", "notifications", "settings", "help"],
  "team-leader": ["dashboard", "participants", "shift", "timeline", "roster", "timepay", "arrivals", "incidents", "sites", "compliance", "billing", "budgets", "assistant", "comms", "support-circle", "marketplace", "learning", "community", "review-ready", "wellbeing", "reports", "notifications", "settings", "help"],
  ...
  "provider-admin": ["provider", "dashboard", "participants", "timeline", "roster", "timepay", "arrivals", "incidents", "sites", "compliance", "billing", "budgets", "assistant", "comms", "support-circle", "marketplace", "learning", "community", "review-ready", "wellbeing", "reports", "notifications", "settings", "help"],
