...
export const rolePermissions: Record<Role, string[]> = {
  ...
  "support-worker": ["dashboard", "participants", "shift", "timeline", "roster", "availability", "timepay", "arrivals", "incidents", "assistant", "comms", "support-circle", "marketplace", "learning", "community", "wellbeing", "notifications", "settings", "help"],
  "team-leader": ["dashboard", "participants", "shift", "timeline", "roster", "availability", "timepay", "arrivals", "incidents", "sites", "compliance", "billing", "budgets", "assistant", "comms", "support-circle", "marketplace", "learning", "community", "review-ready", "wellbeing", "reports", "notifications", "settings", "help"],
  ...
  "provider-admin": ["provider", "dashboard", "participants", "timeline", "roster", "availability", "timepay", "arrivals", "incidents", "sites", "compliance", "billing", "budgets", "assistant", "comms", "support-circle", "marketplace", "learning", "community", "review-ready", "wellbeing", "reports", "notifications", "settings", "help"],
  ceo: ["executive", "provider", "participants", "timeline", "timepay", "arrivals", "incidents", "sites", "compliance", "billing", "budgets", "comms", "support-circle", "marketplace", "review-ready", "wellbeing", "reports", "notifications", "settings", "help"],
  "system-admin": ["dashboard", "participants", "roster", "availability", "timepay", "arrivals", "incidents", "sites", "compliance", "billing", "budgets", "reports", "notifications", "settings", "help"],
};
